...
qa_database = {
    ...
    'q8': "🔹 សំណួរ: តើអ្នកធ្លាប់មានបញ្ហាមិនចុះសម្រុងជាមួយមិត្តរួមការងារដែរឬទេ?\n\n🔸 ចម្លើយ: មានតែយើងដោះស្រាយដោយការយកហេតុផលមកនិយាយគ្នា ស្ដាប់ភាគីម្ខាងទៀត ដើម្បីរក្សាទំនាក់ទំនងល្អ។",
    ...
    'q10': "🔹 សំណួរ: តើអ្នកមានសំណួរអ្វីចង់សួរខាងក្រុមហ៊ុនយើងវិញទេ?\n\n🔸 ចម្លើយ: ចង់សួរពីបច្ចេកវិទ្យាដែលក្រុមការងារកំពុងប្រើប្រាស់ និងដំណើរការវាយតម្លៃការងាររបស់ក្រុមហ៊ុន។"
}
